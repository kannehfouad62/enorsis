...
if (
  ...
  console.log(
    "Runtime Policy Consumption & Guardrails metadata already present.",
  );
  process.exit(0);
}

const entry = `  "/app/analytics/outcome-learning/runtime-policy": {
...
console.log(
  "Registered Runtime Policy Consumption & Guardrails metadata.",
);

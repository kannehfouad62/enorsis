...
if (
  ...
  console.log(
    "Orchestration Observability metadata already present.",
  );
  process.exit(0);
}

const entry = `  "/app/automation/orchestrator/observability": {
...
console.log(
  "Registered Orchestration Observability metadata.",
);

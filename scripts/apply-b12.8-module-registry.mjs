...
if (
  ...
  console.log(
    "Predictive Procurement Policy Adoption metadata already present.",
  );
  process.exit(0);
}

const entry = `  "/app/analytics/outcome-learning/runtime-adoption": {
...
console.log(
  "Registered Predictive Procurement Policy Adoption metadata.",
);

...
if (
  ...
  console.log(
    "Controlled Autonomous Execution metadata already present.",
  );
  process.exit(0);
}

const entry = `  "/app/governance/autonomous-execution": {
...
console.log(
  "Registered Controlled Autonomous Execution metadata.",
);

...
if (
  ...
  console.log(
    "Native Inventory Rebalancing Adapter metadata already present.",
  );
  process.exit(0);
}

const entry = `  "/app/governance/autonomous-execution/native-drafts/inventory": {
...
console.log(
  "Registered Native Inventory Rebalancing Adapter metadata.",
);

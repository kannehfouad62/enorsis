...
const regions: Array<{
  ...
  { code: "AF_ME", label: "Africa & Middle East", currency: "USD" },
];
        ...
        >
          <div className="flex items-start justify-between border-b border-slate-100 px-5 py-4">
            <div>
              ...
              <p className="mt-1 text-xs leading-5 text-slate-500">
                Personalize regional formatting and currency display across Enorsis.
              </p>
            </div>

            <button
              type="button"
              aria-label="Close region and currency menu"
              onClick={() =>
                setOpen(false)
              }
          ...
          <div className="p-5">
            ...
            <div className="mt-5 rounded-2xl bg-slate-50 p-4">
              ...
              <p className="mt-1 text-xs leading-5 text-slate-500">
                English · {selectedRegion.label} · {selectedRegion.currency}
              </p>
              <p className="mt-2 text-[10px] leading-4 text-slate-400">
                Regional preferences are stored on this device. Transaction currency and enterprise tenant configuration remain governed by their respective Enorsis controls.
              </p>
            </div>
          </div>
        </div>
